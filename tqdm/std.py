...
class tqdm(Comparable):
    ...
    monitor = None
    _instances = WeakSet()
    _simultaneous_bars_counters = dict()
    ...
    def __new__(cls, *_, **__):
        ...
        with cls.get_lock():  # also constructs lock if non-existent
            ...
            cls._simultaneous_bars_counters = dict()
    ...
    def __init__(self, iterable=None, desc=None, total=None, leave=True, file=None,
                 ...
                 lock_args=None, nrows=None, colour=None, terminate_lines=True,
                 gui=False, **kwargs):
        """
        Parameters
        ----------
        ...
        if leave and not disable:
            with self._lock:
                self._simultaneous_bars_counters[file] = \
                    max(abs(self.pos) + 1,
                        self._simultaneous_bars_counters.get(file, -1))
